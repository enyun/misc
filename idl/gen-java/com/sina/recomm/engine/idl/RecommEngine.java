...
public class RecommEngine {

  public interface Iface extends com.facebook.fb303.FacebookService.Iface {

    public RecommendationResponse query(RecommendationRequest request) throws org.apache.thrift.TException;

  }

  public interface AsyncIface extends com.facebook.fb303.FacebookService .AsyncIface {

    public void query(RecommendationRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends com.facebook.fb303.FacebookService.Client implements Iface {
    ...
    public void send_query(RecommendationRequest request) throws org.apache.thrift.TException
    {
    ...
    public RecommendationResponse recv_query() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends com.facebook.fb303.FacebookService.AsyncClient implements AsyncIface {
    ...
    public static class query_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public RecommendationResponse getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.facebook.fb303.FacebookService.AsyncProcessor<I> {
    ...
    public static class query<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, query_args, RecommendationResponse> {
      public query() {
        super("query");
      }
      ...
      public AsyncMethodCallback<RecommendationResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<RecommendationResponse>() { 
          public void onComplete(RecommendationResponse o) {
            query_result result = new query_result();
            result.success = o;
            try {
      ...
      public void start(I iface, query_args args, org.apache.thrift.async.AsyncMethodCallback<RecommendationResponse> resultHandler) throws TException {
        iface.query(args.request,resultHandler);
      }
    }
  ...
  public static class query_args implements org.apache.thrift.TBase<query_args, query_args._Fields>, java.io.Serializable, Cloneable, Comparable<query_args>   {
    ...
    public RecommendationRequest request; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RecommendationRequest.class)));
    ...
    public query_args(query_args other) {
      if (other.isSetRequest()) {
        this.request = new RecommendationRequest(other.request);
      }
    }
    ...
    public query_args setRequest(RecommendationRequest request) {
      this.request = request;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((RecommendationRequest)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.request = new RecommendationRequest();
  ...
  public static class query_result implements org.apache.thrift.TBase<query_result, query_result._Fields>, java.io.Serializable, Cloneable, Comparable<query_result>   {
    ...
    public RecommendationResponse success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, RecommendationResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public query_result(query_result other) {
      if (other.isSetSuccess()) {
        this.success = new RecommendationResponse(other.success);
      }
    }
    ...
    public RecommendationResponse getSuccess() {
      return this.success;
    }

    public query_result setSuccess(RecommendationResponse success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((RecommendationResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, query_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new RecommendationResponse();
