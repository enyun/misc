...
THRIFT=/Users/admin/soft/homebrew/bin/thrift
...
CFLAGS += -I./ -I./include -I./src -I./idl/gen-cpp/ \
		-I/Users/admin/soft/homebrew/Cellar/boost/1.56.0/include \
		-I/Users/admin/soft/homebrew/Cellar/libevent/2.0.21/include \
		-I/Users/admin/soft/homebrew/Cellar/thrift/0.9.1/include -Wall $(OPT) -pthread -fPIC 

CXXFLAGS += -I. -I./include -I./src -I./idl/gen-cpp/ \
		-I/Users/admin/soft/homebrew/Cellar/boost/1.56.0/include \
		-I/Users/admin/soft/homebrew/Cellar/libevent/2.0.21/include \
		-I/Users/admin/soft/homebrew/Cellar/thrift/0.9.1/include \
		-DHAVE_NETINET_IN_H -Wall $(OPT) -pthread -fPIC -std=c++0x
             
LDFLAGS += -rdynamic -L./lib -L/usr/local/lib \
			-L/Users/admin/soft/homebrew/Cellar/boost/1.56.0/lib \
			-L/Users/admin/soft/homebrew/Cellar/thrift/0.9.1/lib  \
			-L/Users/admin/soft/homebrew/Cellar/libevent/2.0.21/lib

#/Users/admin/soft/homebrew/Cellar/boost/1.56.0/lib
